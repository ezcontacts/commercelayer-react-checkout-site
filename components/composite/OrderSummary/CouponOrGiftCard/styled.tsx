...
import GiftCardOrCouponInput from "@ezcontacts/react-components/gift_cards/GiftCardOrCouponInput"
import GiftCardOrCouponRemoveButton from "@ezcontacts/react-components/gift_cards/GiftCardOrCouponRemoveButton"
...
export const StyledGiftCardOrCouponRemoveButton = styled(
  ...
  ${tw`ml-2 font-bold border-b leading-none border-black border-opacity-10 md: transition ease-in duration-200 hover:border-opacity-50 hover:text-primary-dark focus:outline-none`}
`
